...
if __name__ == "__main__":
    ...
    pop = [Chromosome([1,1,1,1], weights, 100, profits), Chromosome([1,0,0,0], weights, 100, profits), Chromosome([1,0,1,0], weights, 100, profits), Chromosome([1,0,0,1], weights, 100, profits)]
